...
const hub = () => withPage("hub", hubPage(src), async (b) => {
  ...
  record("hub: world loot and its panel are off by default", !loaded.lootEnabled && loaded.worldCrates === 0 && !loaded.jetpackHidden && loaded.lootTabHidden && loaded.worldLootHintHidden, JSON.stringify(loaded));
