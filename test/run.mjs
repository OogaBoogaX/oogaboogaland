...
const daylightNight = () => withPage("daylight night", hubPage(src, "hour=22&day=80"), async (b) => {
  ...
  record("daylight: night ambient stays readable and contrasted while below-ground sunlight is disabled", night.darkest >= 0.225 && night.silhouetteContrast >= 0.08 && night.altitude < 0 && night.strength <= 0.18 && night.shadow <= 0.13, JSON.stringify(night));
